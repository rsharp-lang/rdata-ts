...
declare const LengthRewriter: any;
declare const KeyExtractor: any;
declare const ByteWriter: any;
declare const ObjectCounter: any;
declare const zlib: any;
declare const create_package: any;
